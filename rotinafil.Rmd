...
{
  # Step 1: Create fType
  fType <- data.frame(type = c("absolute", "rate", "per capita", "por mil", "proportion"), type_code = c(1:5))
...

{
  ...
  dHealth$standard_code[is.na(dHealth$standard_code)] <- 6
  
  # Step 4: Join type code
  dHealth$type_code <- case_when(dHealth$variable_code == 4 ~ 1,
                            dHealth$variable_code == c(6:22) ~ 2,
                            dHealth$variable_code == 1 ~ 3,
                            TRUE ~ 4)
...

{
  ...
  dAuxEmerg$standard <- case_when(dAuxEmerg$variable == "Elegiveis ao Auxilio" ~ "pessoas",
                                  TRUE ~ "R$ 1,00")
...

{
  ...
  dPover$type_code <- case_when(dPover$variable == "Elegiveis ao Auxilio" ~ 5,
                                dPover$variable == "Pessoas no CadUnico" ~5,
                                dPover$variable == "Pessoas no Bolsa Familia" ~ 5,
