...

{
  ...
  # Step 4:Create type code
  fType <- as.data.frame(cbind(c(1,2), c("absolute", "rate")))
  colnames(fType) <- c("type_code", "type")
  
  # Step 5: Export to db parameters paste
  ...
  write.csv(fHealthStand, 
            "C:/Users/CepaTech/Documents/GitHub/powerbi3.0/db/parameters/fHealthStandard.csv")
  write.csv(fType, 
...

{
  ...
  dHealth$type_code <- case_when(dHealth$standar_code == 4 ~ 2,
                            TRUE ~1)
...

{
  ...
  # Step3: Change dot to comma for use in power bi
  dHealth$result <- gsub("\\.", ",", dHealth$result)
  
  # Step 4: Export clean base
